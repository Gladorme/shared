...
compiler checks enabled by the suspicious and performance categories. It also includes React Doctor's lint-native rules. Run `npm run doctor` for the full React Doctor
